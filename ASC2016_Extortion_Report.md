...
```
 ...
 30331.411      0.000   2499.000   2616.411 
```
...
1 0.5840637 7.903414 13.53177 30331.41      0 2499
```
...
|      Mean| Variance|    Ratio|    Index| Pvalue|   DF|
|---------:|--------:|--------:|--------:|------:|----:|
| 0.5840637| 7.903414| 13.53177| 30331.41|      0| 2499|
...
2                 extortions 1279        175       733    0.584    2.811
4       rep_extortion_victim 1279        111        NA    0.087       NA
6                     bribes 1279        164       362    0.290    1.173
...
|:-------------------------|----:|----------:|---------:|--------:|--------:|-------:|---------:|
|extortions                | 1279|        175|       733|    0.584|    2.811|   0.000|    33.000|
|rep_extortion_victim      | 1279|        111|        NA|    0.087|       NA|      NA|        NA|
|bribes                    | 1279|        164|       362|    0.290|    1.173|   0.000|    16.000|
...
glm(formula = complied_bin ~ extortion_type + time + n_offenders + 
    had_weapon + with_violence + reported + rep_extortion_victim + 
    bribe_victim + size + subsector + yearsquant + loghoms + 
    logpop, family = "binomial", data = m1df)

Deviance Residuals: 
    Min       1Q   Median       3Q      Max  
-1.5131  -0.4071  -0.2672  -0.1576   2.6959  

Coefficients:
                              Estimate Std. Error z value Pr(>|z|)    
(Intercept)                   -2.57636    0.87904  -2.931 0.003380 ** 
extortion_typeStreet           1.10590    0.61328   1.803 0.071350 .  
extortion_typePremises        19.09663 1738.19499   0.011 0.991234    
extortion_typeCobro de piso    2.72450    1.01964   2.672 0.007539 ** 
timeAfternoon                  0.10535    0.38732   0.272 0.785630    
timeEvening                   -0.27762    0.51477  -0.539 0.589680    
timeNight                      1.89715    1.07944   1.758 0.078828 .  
timeDK/DA                      1.73018    1.48790   1.163 0.244896    
n_offenders2                   1.09228    0.38104   2.867 0.004150 ** 
n_offenders3                   0.91787    0.66593   1.378 0.168098    
n_offenders4+                  2.90254    0.84647   3.429 0.000606 ***
n_offendersDK/DA               0.38230    0.78013   0.490 0.624106    
had_weaponYes                  0.99144    0.77728   1.276 0.202127    
had_weaponDK/DA               -0.01982    0.37726  -0.053 0.958108    
with_violenceYes               0.39916    0.88612   0.450 0.652384    
with_violenceDK/DA             0.73252    0.66379   1.104 0.269795    
reportedYes                    0.69164    0.40719   1.699 0.089397 .  
rep_extortion_victim1          0.89057    0.56632   1.573 0.115821    
bribe_victim1                 -0.01049    0.51447  -0.020 0.983739    
sizeMedium                    -0.13732    0.47367  -0.290 0.771889    
sizeSmall                      0.57780    0.45316   1.275 0.202291    
sizeMicro                     -0.68671    0.51068  -1.345 0.178724    
subsectorHotelsRestBar        -1.77619    0.86855  -2.045 0.040855 *  
subsectorIndustry             -0.98215    0.71418  -1.375 0.169068    
subsectorServices_Hi         -16.92916 1290.83792  -0.013 0.989536    
subsectorServices_Low         -0.75535    0.74290  -1.017 0.309274    
subsectorServices_Mid         -0.51573    0.79079  -0.652 0.514295    
subsectorTransport            -1.85155    1.09513  -1.691 0.090892 .  
subsectorWholesale             0.15953    0.94133   0.169 0.865425    
yearsquant(8,16]              -0.21149    0.56152  -0.377 0.706440    
yearsquant(16,25]              0.68138    0.50236   1.356 0.174982    
yearsquant(25,34]             -0.44815    0.59271  -0.756 0.449584    
yearsquant(34,43]              1.06547    0.52406   2.033 0.042043 *  
loghoms                       -0.06311    0.24019  -0.263 0.792728    
logpop                         0.46575    0.36029   1.293 0.196109    
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
(Dispersion parameter for binomial family taken to be 1)
    ...
    Null deviance: 439.55  on 612  degrees of freedom
Residual deviance: 284.90  on 578  degrees of freedom
AIC: 354.9
...
```
         llh      llhNull           G2     McFadden         r2ML 
-142.4523680 -219.7732617  154.6417874    0.3518212    0.2229654 
        r2CU 
   0.4356448 
```
...
(Intercept)                     -2.58 ** 
                                (0.88)   
extortion_typeStreet             1.11    
                                (0.61)   
extortion_typePremises          19.10    
                             (1738.19)   
extortion_typeCobro de piso      2.72 ** 
                                (1.02)   
timeAfternoon                    0.11    
                                (0.39)   
timeEvening                     -0.28    
...
n_offenders4+                    2.90 ***
                                (0.85)   
n_offendersDK/DA                 0.38    
                                (0.78)   
had_weaponYes                    0.99    
                                (0.78)   
had_weaponDK/DA                 -0.02    
                                (0.38)   
with_violenceYes                 0.40    
                                (0.89)   
with_violenceDK/DA               0.73    
                                (0.66)   
reportedYes                      0.69    
                                (0.41)   
rep_extortion_victim1            0.89    
                                (0.57)   
bribe_victim1                   -0.01    
                                (0.51)   
sizeMedium                      -0.14    
...
sizeMicro                       -0.69    
                                (0.51)   
subsectorHotelsRestBar          -1.78 *  
                                (0.87)   
subsectorIndustry               -0.98    
                                (0.71)   
subsectorServices_Hi           -16.93    
                             (1290.84)   
subsectorServices_Low           -0.76    
                                (0.74)   
subsectorServices_Mid           -0.52    
                                (0.79)   
subsectorTransport              -1.85    
                                (1.10)   
subsectorWholesale               0.16    
                                (0.94)   
yearsquant(8,16]                -0.21    
                                (0.56)   
yearsquant(16,25]                0.68    
                                (0.50)   
yearsquant(25,34]               -0.45    
                                (0.59)   
yearsquant(34,43]                1.07 *  
                                (0.52)   
loghoms                         -0.06    
                                (0.24)   
logpop                           0.47    
...
```
                                   2.5 %       97.5 %
(Intercept)                   -4.4489699  -0.96009028
extortion_typeStreet          -0.1338868   2.29250800
extortion_typePremises       -49.2252153 624.40910922
extortion_typeCobro de piso    0.7455922   4.83877969
timeAfternoon                 -0.6470695   0.88099026
timeEvening                   -1.3315782   0.70496808
timeNight                     -0.4801055   3.88744894
timeDK/DA                     -1.7157163   4.51142690
n_offenders2                   0.3363934   1.83945233
n_offenders3                  -0.4767791   2.16855886
n_offenders4+                  1.2511202   4.60567889
n_offendersDK/DA              -1.3933422   1.76173074
had_weaponYes                 -0.5389455   2.53181186
had_weaponDK/DA               -0.7650161   0.72373829
with_violenceYes              -1.3921542   2.11968171
with_violenceDK/DA            -0.6854648   1.96814385
reportedYes                   -0.1360865   1.47175057
rep_extortion_victim1         -0.3018831   1.94819816
bribe_victim1                 -1.1029620   0.93932251
sizeMedium                    -1.0759548   0.79761627
sizeSmall                     -0.3054019   1.48435224
sizeMicro                     -1.7193970   0.30450857
subsectorHotelsRestBar        -3.5007017  -0.01621048
subsectorIndustry             -2.3127770   0.54950793
subsectorServices_Hi        -510.2215753  25.82407723
subsectorServices_Low         -2.1526108   0.82302553
subsectorServices_Mid         -2.0227783   1.14151426
subsectorTransport            -4.1293087   0.24695550
subsectorWholesale            -1.7531801   2.04148932
yearsquant(8,16]              -1.3453739   0.88462122
yearsquant(16,25]             -0.2958870   1.69133734
yearsquant(25,34]             -1.6614542   0.69325096
yearsquant(34,43]              0.0511358   2.12203179
loghoms                       -0.5387815   0.40662074
logpop                        -0.2306697   1.18727439
```
...
Model 1: complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
    with_violence + reported + rep_extortion_victim + bribe_victim + 
    size + subsector + yearsquant + loghoms + logpop
Model 2: complied_bin ~ 1
  #Df  LogLik  Df  Chisq Pr(>Chisq)    
1  35 -142.45                          
2   1 -219.77 -34 154.64  < 2.2e-16 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
| #Df|    LogLik|  Df|    Chisq| Pr(>Chisq)|
|---:|---------:|---:|--------:|----------:|
|  35| -142.4524|  NA|       NA|         NA|
|   1| -219.7733| -34| 154.6418|          0|
...
bribe_victim          1    0.092       594     317.92   0.094   0.75944
size                  3    7.514       591     310.40   8.154   0.04293
subsector             7   12.083       584     298.32  10.496   0.16218
yearsquant            4   10.486       580     287.83  10.882   0.02792
loghoms               1    1.222       579     286.61   1.206   0.27218
logpop                1    1.705       578     284.90   1.683   0.19453
...
|bribe_victim         |  1|  0.0916042|       594|   317.9151|   0.0937718| 0.7594358|
|size                 |  3|  7.5144030|       591|   310.4007|   8.1542287| 0.0429295|
|subsector            |  7| 12.0829262|       584|   298.3177|  10.4956715| 0.1621804|
|yearsquant           |  4| 10.4861063|       580|   287.8316|  10.8820148| 0.0279225|
|loghoms              |  1|  1.2216174|       579|   286.6100|   1.2057401| 0.2721774|
|logpop               |  1|  1.7052698|       578|   284.9047|   1.6829443| 0.1945337|
...
bribe_victim          1    0.092       594     317.92   0.76215    
size                  3    7.514       591     310.40   0.05719 .  
subsector             7   12.083       584     298.32   0.09786 .  
yearsquant            4   10.486       580     287.83   0.03299 *  
loghoms               1    1.222       579     286.61   0.26904    
logpop                1    1.705       578     284.90   0.19160    
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
|bribe_victim         |  1|  0.0916042|       594|   317.9151| 0.7621476|
|size                 |  3|  7.5144030|       591|   310.4007| 0.0571895|
|subsector            |  7| 12.0829262|       584|   298.3177| 0.0978646|
|yearsquant           |  4| 10.4861063|       580|   287.8316| 0.0329889|
|loghoms              |  1|  1.2216174|       579|   286.6100| 0.2690435|
|logpop               |  1|  1.7052698|       578|   284.9047| 0.1916002|
...
```
                         GVIF Df GVIF^(1/(2*Df))
extortion_type       2.366623  3        1.154396
time                 2.022792  4        1.092053
n_offenders          2.778971  4        1.136280
had_weapon           2.984990  2        1.314425
with_violence        2.079957  2        1.200919
reported             1.143517  1        1.069353
rep_extortion_victim 1.210771  1        1.100351
bribe_victim         1.091191  1        1.044601
size                 1.559140  3        1.076831
subsector            2.515143  7        1.068099
yearsquant           1.993826  4        1.090086
loghoms              2.702926  1        1.644058
logpop               2.729747  1        1.652194
```
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.62737 -0.11867 -0.05474  0.01080  0.96944 

Coefficients:
                              Estimate Std. Error t value Pr(>|t|)    
(Intercept)                  1.1149120  0.0761072  14.649  < 2e-16 ***
extortion_typeStreet         0.1581474  0.0544549   2.904 0.003823 ** 
extortion_typePremises       0.5697220  0.1014193   5.617 3.01e-08 ***
extortion_typeCobro de piso  0.4370236  0.1100403   3.971 8.04e-05 ***
timeAfternoon               -0.0001933  0.0255542  -0.008 0.993966    
timeEvening                 -0.0157639  0.0343450  -0.459 0.646417    
timeNight                    0.1940581  0.1068215   1.817 0.069787 .  
timeDK/DA                    0.2250869  0.1623141   1.387 0.166057    
n_offenders2                 0.0773188  0.0292086   2.647 0.008339 ** 
n_offenders3                 0.0716946  0.0532627   1.346 0.178812    
n_offenders4+                0.2848755  0.0834365   3.414 0.000684 ***
n_offendersDK/DA             0.0213642  0.0521964   0.409 0.682467    
had_weaponYes                0.1870735  0.0794608   2.354 0.018892 *  
had_weaponDK/DA              0.0008221  0.0242608   0.034 0.972978    
with_violenceYes             0.0735577  0.0893849   0.823 0.410886    
with_violenceDK/DA           0.0596808  0.0488673   1.221 0.222476    
reportedYes                  0.0484705  0.0316728   1.530 0.126477    
rep_extortion_victim1        0.0828838  0.0450693   1.839 0.066424 .  
bribe_victim1                0.0094924  0.0323499   0.293 0.769299    
sizeMedium                  -0.0109581  0.0319601  -0.343 0.731822    
sizeSmall                    0.0494086  0.0346063   1.428 0.153909    
sizeMicro                   -0.0297799  0.0312241  -0.954 0.340611    
subsectorHotelsRestBar      -0.1425755  0.0737853  -1.932 0.053811 .  
subsectorIndustry           -0.1029760  0.0699312  -1.473 0.141421    
subsectorServices_Hi        -0.1631535  0.0914141  -1.785 0.074822 .  
subsectorServices_Low       -0.0986918  0.0719055  -1.373 0.170434    
subsectorServices_Mid       -0.0778652  0.0748414  -1.040 0.298588    
subsectorTransport          -0.1854044  0.0846307  -2.191 0.028869 *  
subsectorWholesale          -0.0276605  0.0881978  -0.314 0.753924    
yearsquant(8,16]             0.0026898  0.0346668   0.078 0.938182    
yearsquant(16,25]            0.0581959  0.0350833   1.659 0.097701 .  
yearsquant(25,34]           -0.0057296  0.0346425  -0.165 0.868693    
yearsquant(34,43]            0.0930358  0.0363559   2.559 0.010750 *  
loghoms                     -0.0062639  0.0162652  -0.385 0.700295    
logpop                       0.0343946  0.0237059   1.451 0.147354    
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1

Residual standard error: 0.2703 on 578 degrees of freedom
Multiple R-squared:  0.3275,	Adjusted R-squared:  0.288 
F-statistic:  8.28 on 34 and 578 DF,  p-value: < 2.2e-16
```
...
```
                         GVIF Df GVIF^(1/(2*Df))
extortion_type       2.485724  3        1.163882
time                 1.320359  4        1.035348
n_offenders          2.784366  4        1.136556
had_weapon           3.228810  2        1.340481
with_violence        1.619866  2        1.128158
reported             1.054666  1        1.026969
rep_extortion_victim 1.088040  1        1.043092
bribe_victim         1.100240  1        1.048923
size                 1.222561  3        1.034058
subsector            1.520833  7        1.030400
yearsquant           1.365099  4        1.039670
loghoms              2.633080  1        1.622677
logpop               2.570277  1        1.603208
```
...
```
  model      RMSE    NRMSE    CVRMSE
1    n1 0.2558217 0.999184 0.1545497
```
...
|model |      RMSE|    NRMSE|    CVRMSE|
|:-----|---------:|--------:|---------:|
|n1    | 0.2558217| 0.999184| 0.1545497|
...
complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
    ...
    size + subsector + yearsquant + loghoms + logpop
                       ...
                       Df Deviance    AIC
- time                  4   289.39 351.39
- with_violence         2   286.24 352.24
- had_weapon            2   286.55 352.55
- bribe_victim          1   284.90 352.91
- loghoms               1   284.97 352.97
- subsector             7   297.54 353.54
- logpop                1   286.61 354.61
<none>                      284.90 354.90
- rep_extortion_victim  1   287.13 355.13
- reported              1   287.62 355.62
- size                  3   291.85 355.85
- yearsquant            4   295.28 357.28
- n_offenders           4   300.69 362.69
- extortion_type        3   305.19 369.19

Step:  AIC=351.39
complied_bin ~ extortion_type + n_offenders + had_weapon + with_violence + 
    reported + rep_extortion_victim + bribe_victim + size + subsector + 
    yearsquant + loghoms + logpop

                       Df Deviance    AIC
- with_violence         2   290.78 348.78
- had_weapon            2   290.83 348.83
- bribe_victim          1   289.39 349.39
- loghoms               1   289.42 349.41
- logpop                1   290.69 350.69
- size                  3   294.78 350.78
<none>                      289.39 351.39
- subsector             7   303.71 351.71
- reported              1   291.71 351.71
- rep_extortion_victim  1   291.84 351.84
- yearsquant            4   300.15 354.15
- n_offenders           4   305.98 359.98
- extortion_type        3   310.33 366.33

Step:  AIC=348.78
complied_bin ~ extortion_type + n_offenders + had_weapon + reported + 
    rep_extortion_victim + bribe_victim + size + subsector + 
    yearsquant + loghoms + logpop

                       Df Deviance    AIC
- had_weapon            2   292.56 346.56
- bribe_victim          1   290.79 346.79
- loghoms               1   290.84 346.84
- logpop                1   292.48 348.48
- size                  3   296.60 348.60
- subsector             7   304.73 348.73
<none>                      290.78 348.78
- rep_extortion_victim  1   292.97 348.97
- reported              1   293.30 349.30
- yearsquant            4   300.99 350.98
- n_offenders           4   307.30 357.30
- extortion_type        3   312.00 364.00
...
complied_bin ~ extortion_type + n_offenders + reported + rep_extortion_victim + 
    ...
    logpop
                       ...
                       Df Deviance    AIC
- bribe_victim          1   292.56 344.56
- loghoms               1   292.69 344.69
- subsector             7   306.11 346.11
<none>                      292.56 346.56
- size                  3   298.82 346.82
- logpop                1   294.83 346.83
- rep_extortion_victim  1   294.89 346.89
- reported              1   294.98 346.98
- yearsquant            4   302.52 348.52
- n_offenders           4   319.68 365.68
- extortion_type        3   325.73 373.73
...
complied_bin ~ extortion_type + n_offenders + reported + rep_extortion_victim + 
    size + subsector + yearsquant + loghoms + logpop
                       ...
                       Df Deviance    AIC
- loghoms               1   292.69 342.69
- subsector             7   306.13 344.13
<none>                      292.56 344.56
- logpop                1   294.83 344.83
- size                  3   298.83 344.83
- rep_extortion_victim  1   294.92 344.92
- reported              1   294.99 344.99
- yearsquant            4   302.52 346.52
- n_offenders           4   319.71 363.71
- extortion_type        3   325.74 371.74

Step:  AIC=342.69
complied_bin ~ extortion_type + n_offenders + reported + rep_extortion_victim + 
    size + subsector + yearsquant + logpop

                       Df Deviance    AIC
- subsector             7   306.21 342.21
<none>                      292.69 342.69
- size                  3   299.00 343.00
- rep_extortion_victim  1   295.10 343.10
- reported              1   295.16 343.16
- logpop                1   296.19 344.19
- yearsquant            4   302.79 344.79
- n_offenders           4   320.00 362.00
- extortion_type        3   325.86 369.86

Step:  AIC=342.21
complied_bin ~ extortion_type + n_offenders + reported + rep_extortion_victim + 
    size + yearsquant + logpop

                       Df Deviance    AIC
<none>                      306.21 342.21
- size                  3   312.65 342.65
- reported              1   308.70 342.70
- rep_extortion_victim  1   308.77 342.77
- yearsquant            4   315.12 343.12
- logpop                1   309.39 343.39
- n_offenders           4   331.83 359.83
- extortion_type        3   340.01 370.01
```
...
Call:
glm(formula = complied_bin ~ extortion_type + n_offenders + reported + 
    rep_extortion_victim + size + yearsquant + logpop, family = "binomial", 
    data = m1df)

Deviance Residuals: 
    Min       1Q   Median       3Q      Max  
-1.5238  -0.4186  -0.3019  -0.2095   2.8526  

Coefficients:
                             Estimate Std. Error z value Pr(>|z|)    
(Intercept)                  -3.29420    0.49405  -6.668 2.60e-11 ***
extortion_typeStreet          1.31406    0.45473   2.890  0.00386 ** 
extortion_typePremises       17.61390  648.41444   0.027  0.97833    
extortion_typeCobro de piso   2.58832    0.92550   2.797  0.00516 ** 
n_offenders2                  1.02138    0.35918   2.844  0.00446 ** 
n_offenders3                  0.88444    0.62338   1.419  0.15597    
n_offenders4+                 3.13664    0.65732   4.772 1.83e-06 ***
n_offendersDK/DA              0.60291    0.68367   0.882  0.37785    
reportedYes                   0.62638    0.38503   1.627  0.10378    
rep_extortion_victim1         0.90192    0.53001   1.702  0.08881 .  
sizeMedium                   -0.26923    0.43551  -0.618  0.53645    
sizeSmall                     0.45664    0.41535   1.099  0.27160    
sizeMicro                    -0.66160    0.46353  -1.427  0.15349    
yearsquant(8,16]             -0.05553    0.53555  -0.104  0.91742    
yearsquant(16,25]             0.78705    0.48181   1.634  0.10236    
yearsquant(25,34]            -0.26616    0.53951  -0.493  0.62177    
yearsquant(34,43]             0.92199    0.47924   1.924  0.05437 .  
logpop                        0.38005    0.21491   1.768  0.07699 .  
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
(Dispersion parameter for binomial family taken to be 1)
    ...
    Null deviance: 439.55  on 612  degrees of freedom
Residual deviance: 306.21  on 595  degrees of freedom
AIC: 342.21
...
n_offenders4+                   3.14 ***
                               (0.66)   
n_offendersDK/DA                0.60    
                               (0.68)   
reportedYes                     0.63    
                               (0.39)   
rep_extortion_victim1           0.90    
                               (0.53)   
sizeMedium                     -0.27    
                               (0.44)   
sizeSmall                       0.46    
...
sizeMicro                      -0.66    
                               (0.46)   
yearsquant(8,16]               -0.06    
                               (0.54)   
yearsquant(16,25]               0.79    
                               (0.48)   
yearsquant(25,34]              -0.27    
                               (0.54)   
yearsquant(34,43]               0.92    
                               (0.48)   
logpop                          0.38    
                               (0.21)   
----------------------------------------
...
(Intercept)                     -2.58 **     -3.29 ***
                                (0.88)       (0.49)   
extortion_typeStreet             1.11         1.31 ** 
                                (0.61)       (0.45)   
extortion_typePremises          19.10        17.61    
                             (1738.19)     (648.41)   
extortion_typeCobro de piso      2.72 **      2.59 ** 
                                (1.02)       (0.93)   
timeAfternoon                    0.11                 
                                (0.39)                
timeEvening                     -0.28                 
...
timeDK/DA                        1.73                 
                                (1.49)                
n_offenders2                     1.09 **      1.02 ** 
                                (0.38)       (0.36)   
n_offenders3                     0.92         0.88    
                                (0.67)       (0.62)   
n_offenders4+                    2.90 ***     3.14 ***
                                (0.85)       (0.66)   
n_offendersDK/DA                 0.38         0.60    
                                (0.78)       (0.68)   
had_weaponYes                    0.99                 
                                (0.78)                
had_weaponDK/DA                 -0.02                 
...
with_violenceDK/DA               0.73                 
                                (0.66)                
reportedYes                      0.69         0.63    
                                (0.41)       (0.39)   
rep_extortion_victim1            0.89         0.90    
                                (0.57)       (0.53)   
bribe_victim1                   -0.01                 
                                (0.51)                
sizeMedium                      -0.14        -0.27    
                                (0.47)       (0.44)   
sizeSmall                        0.58         0.46    
                                (0.45)       (0.42)   
sizeMicro                       -0.69        -0.66    
...
subsectorWholesale               0.16                 
                                (0.94)                
yearsquant(8,16]                -0.21        -0.06    
                                (0.56)       (0.54)   
yearsquant(16,25]                0.68         0.79    
                                (0.50)       (0.48)   
yearsquant(25,34]               -0.45        -0.27    
                                (0.59)       (0.54)   
yearsquant(34,43]                1.07 *       0.92    
                                (0.52)       (0.48)   
loghoms                         -0.06                 
                                (0.24)                
logpop                           0.47         0.38    
...
AIC                            354.90       342.21    
BIC                            509.55       421.74    
Log Likelihood                -142.45      -153.10    
Deviance                       284.90       306.21    
Num. obs.                      613          613       
======================================================
*** p < 0.001, ** p < 0.01, * p < 0.05
```
...
```
             Step Df    Deviance Resid. Df Resid. Dev      AIC
1                 NA          NA       578   284.9047 354.9047
2          - time  4  4.48320447       582   289.3879 351.3879
3 - with_violence  2  1.39448488       584   290.7824 348.7824
4    - had_weapon  2  1.77315478       586   292.5556 346.5556
5  - bribe_victim  1  0.00445884       587   292.5600 344.5600
6       - loghoms  1  0.13341190       588   292.6935 342.6935
7     - subsector  7 13.51595037       595   306.2094 342.2094
```
...
|Step            | Df|   Deviance| Resid. Df| Resid. Dev|      AIC|
|:---------------|--:|----------:|---------:|----------:|--------:|
|                | NA|         NA|       578|   284.9047| 354.9047|
|- time          |  4|  4.4832045|       582|   289.3879| 351.3879|
|- with_violence |  2|  1.3944849|       584|   290.7824| 348.7824|
|- had_weapon    |  2|  1.7731548|       586|   292.5556| 346.5556|
|- bribe_victim  |  1|  0.0044588|       587|   292.5600| 344.5600|
|- loghoms       |  1|  0.1334119|       588|   292.6935| 342.6935|
|- subsector     |  7| 13.5159504|       595|   306.2094| 342.2094|
...
complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
    ...
    size + subsector + yearsquant + loghoms + logpop
                     Df Deviance    AIC     LRT  Pr(>Chi)    
<none>                    284.90 354.90                      
extortion_type        3   305.19 369.19 20.2836 0.0001483 ***
time                  4   289.39 351.39  4.4832 0.3445436    
n_offenders           4   300.69 362.69 15.7888 0.0033161 ** 
had_weapon            2   286.55 352.55  1.6434 0.4396837    
with_violence         2   286.24 352.24  1.3327 0.5135849    
reported              1   287.62 355.62  2.7185 0.0991909 .  
rep_extortion_victim  1   287.13 355.13  2.2269 0.1356254    
bribe_victim          1   284.90 352.91  0.0004 0.9837273    
size                  3   291.85 355.85  6.9408 0.0738092 .  
subsector             7   297.54 353.54 12.6363 0.0814822 .  
yearsquant            4   295.28 357.28 10.3776 0.0345253 *  
loghoms               1   284.97 352.97  0.0692 0.7925733    
logpop                1   286.61 354.61  1.7053 0.1916002    
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
|                     | Df| Deviance|      AIC|        LRT|  Pr(>Chi)|
|:--------------------|--:|--------:|--------:|----------:|---------:|
|<none>               | NA| 284.9047| 354.9047|         NA|        NA|
|extortion_type       |  3| 305.1884| 369.1884| 20.2836181| 0.0001483|
|time                 |  4| 289.3879| 351.3879|  4.4832045| 0.3445436|
|n_offenders          |  4| 300.6935| 362.6935| 15.7887806| 0.0033161|
|had_weapon           |  2| 286.5481| 352.5481|  1.6433993| 0.4396837|
|with_violence        |  2| 286.2374| 352.2374|  1.3326798| 0.5135849|
|reported             |  1| 287.6232| 355.6232|  2.7185042| 0.0991909|
|rep_extortion_victim |  1| 287.1316| 355.1316|  2.2269040| 0.1356254|
|bribe_victim         |  1| 284.9052| 352.9052|  0.0004160| 0.9837273|
|size                 |  3| 291.8455| 355.8455|  6.9407870| 0.0738092|
|subsector            |  7| 297.5410| 353.5410| 12.6362749| 0.0814822|
|yearsquant           |  4| 295.2823| 357.2823| 10.3776122| 0.0345253|
|loghoms              |  1| 284.9739| 352.9739|  0.0691535| 0.7925733|
|logpop               |  1| 286.6100| 354.6100|  1.7052698| 0.1916002|
...
glm(formula = complied_bin ~ extortion_type + time + n_offenders + 
    had_weapon + with_violence + reported + rep_extortion_victim + 
    bribe_victim + size + subsector + yearsquant, family = "binomial", 
    data = m1df)

Deviance Residuals: 
    Min       1Q   Median       3Q      Max  
-1.6048  -0.4101  -0.2690  -0.1564   2.6263  

Coefficients:
                              Estimate Std. Error z value Pr(>|z|)   
(Intercept)                   -2.71802    0.86880  -3.128  0.00176 **
extortion_typeStreet           1.07416    0.59924   1.793  0.07304 . 
extortion_typePremises        18.98298 1764.62896   0.011  0.99142   
extortion_typeCobro de piso    2.75507    1.01827   2.706  0.00682 **
timeAfternoon                  0.17163    0.38212   0.449  0.65333   
timeEvening                   -0.25306    0.50765  -0.498  0.61814   
timeNight                      1.74207    1.05499   1.651  0.09868 . 
timeDK/DA                      1.56086    1.48291   1.053  0.29254   
n_offenders2                   1.07723    0.37822   2.848  0.00440 **
n_offenders3                   0.90863    0.65204   1.394  0.16346   
n_offenders4+                  2.72534    0.83498   3.264  0.00110 **
n_offendersDK/DA               0.42429    0.77535   0.547  0.58423   
had_weaponYes                  1.07562    0.76936   1.398  0.16209   
had_weaponDK/DA               -0.07838    0.37283  -0.210  0.83348   
with_violenceYes               0.56983    0.87222   0.653  0.51356   
with_violenceDK/DA             0.82682    0.64981   1.272  0.20323   
reportedYes                    0.74446    0.40221   1.851  0.06418 . 
rep_extortion_victim1          0.88085    0.56011   1.573  0.11580   
bribe_victim1                  0.01415    0.51238   0.028  0.97797   
sizeMedium                    -0.14116    0.47344  -0.298  0.76558   
sizeSmall                      0.65247    0.45045   1.448  0.14748   
sizeMicro                     -0.60497    0.50374  -1.201  0.22977   
subsectorHotelsRestBar        -1.71051    0.86613  -1.975  0.04828 * 
subsectorIndustry             -0.97943    0.71492  -1.370  0.17069   
subsectorServices_Hi         -17.06498 1289.46980  -0.013  0.98944   
subsectorServices_Low         -0.75440    0.74144  -1.017  0.30892   
subsectorServices_Mid         -0.47427    0.79258  -0.598  0.54958   
subsectorTransport            -1.98498    1.10710  -1.793  0.07298 . 
subsectorWholesale             0.05480    0.94068   0.058  0.95355   
yearsquant(8,16]              -0.21737    0.56011  -0.388  0.69796   
yearsquant(16,25]              0.69821    0.49702   1.405  0.16009   
yearsquant(25,34]             -0.36520    0.58325  -0.626  0.53122   
yearsquant(34,43]              1.10622    0.52175   2.120  0.03399 * 
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
(Dispersion parameter for binomial family taken to be 1)
    ...
    Null deviance: 439.55  on 612  degrees of freedom
Residual deviance: 287.83  on 580  degrees of freedom
AIC: 353.83
...
| #Df|    LogLik| Df|    Chisq| Pr(>Chisq)|
|---:|---------:|--:|--------:|----------:|
|  33| -143.9158| NA|       NA|         NA|
|  35| -142.4524|  2| 2.926887|  0.2314379|
...
Model 2: complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
  ...
  #Df  LogLik Df  Chisq Pr(>Chisq)   
1  17 -160.18                        
2  33 -143.92 16 32.535   0.008511 **
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
|---:|---------:|--:|--------:|----------:|
|  17| -160.1834| NA|       NA|         NA|
|  33| -143.9158| 16| 32.53522|  0.0085111|
...
Model 3: complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
  ...
  #Df  LogLik Df   Chisq Pr(>Chisq)   
1  17 -160.18                         
2  33 -143.92 16 32.5352   0.008511 **
3  35 -142.45  2  2.9269   0.231438   
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
|---:|---------:|--:|---------:|----------:|
|  17| -160.1834| NA|        NA|         NA|
|  33| -143.9158| 16| 32.535220|  0.0085111|
|  35| -142.4524|  2|  2.926887|  0.2314379|
...
Model 3: complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
  ...
  Res.Df Df   Chisq Pr(>Chisq)  
1    596                        
2    580 16 25.3134    0.06449 .
3    578  2  2.8746    0.23757  
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
1   9 -173.29                          
2  17 -160.18  8 26.2211  0.0009626 ***
3  33 -143.92 16 32.5352  0.0085111 ** 
4  35 -142.45  2  2.9269  0.2314379    
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
1    604                      
2    596  8 3.1401 0.001728 **
3    580 16 1.5821 0.068535 . 
4    578  2 1.4373 0.238418   
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
1    604                         
2    596  8 25.1207   0.001483 **
3    580 16 25.3134   0.064487 . 
4    578  2  2.8746   0.237570   
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
=============================================================================================
                             Model 1       Model 2      Model 3      Model 4      Model 5    
---------------------------------------------------------------------------------------------
(Intercept)                     -2.58 **     -3.29 ***     -2.72 **    -3.13 ***    -2.76 ***
                                (0.88)       (0.49)        (0.87)      (0.37)       (0.29)   
extortion_typeStreet             1.11         1.31 **       1.07        1.20 *       2.01 ***
                                (0.61)       (0.45)        (0.60)      (0.51)       (0.38)   
extortion_typePremises          19.10        17.61         18.98       17.89        19.21    
                             (1738.19)     (648.41)     (1764.63)    (645.77)     (719.84)   
extortion_typeCobro de piso      2.72 **      2.59 **       2.76 **     2.83 **      3.04 ***
                                (1.02)       (0.93)        (1.02)      (0.88)       (0.79)   
timeAfternoon                    0.11                       0.17       -0.04         0.01    
                                (0.39)                     (0.38)      (0.36)       (0.34)   
timeEvening                     -0.28                      -0.25       -0.09         0.20    
                                (0.51)                     (0.51)      (0.46)       (0.42)   
timeNight                        1.90                       1.74        1.63         1.73    
                                (1.08)                     (1.05)      (0.94)       (0.89)   
timeDK/DA                        1.73                       1.56        2.17         2.06    
                                (1.49)                     (1.48)      (1.36)       (1.26)   
n_offenders2                     1.09 **      1.02 **       1.08 **     1.03 **              
                                (0.38)       (0.36)        (0.38)      (0.36)                
n_offenders3                     0.92         0.88          0.91        0.75                 
                                (0.67)       (0.62)        (0.65)      (0.60)                
n_offenders4+                    2.90 ***     3.14 ***      2.73 **     2.00 **              
                                (0.85)       (0.66)        (0.83)      (0.75)                
n_offendersDK/DA                 0.38         0.60          0.42        0.40                 
                                (0.78)       (0.68)        (0.78)      (0.73)                
had_weaponYes                    0.99                       1.08        0.92                 
                                (0.78)                     (0.77)      (0.70)                
had_weaponDK/DA                 -0.02                      -0.08       -0.03                 
                                (0.38)                     (0.37)      (0.35)                
with_violenceYes                 0.40                       0.57        0.25                 
                                (0.89)                     (0.87)      (0.79)                
with_violenceDK/DA               0.73                       0.83        0.71                 
                                (0.66)                     (0.65)      (0.62)                
reportedYes                      0.69         0.63          0.74        0.57         0.70 *  
                                (0.41)       (0.39)        (0.40)      (0.37)       (0.35)   
rep_extortion_victim1            0.89         0.90          0.88                             
                                (0.57)       (0.53)        (0.56)                            
bribe_victim1                   -0.01                       0.01                             
                                (0.51)                     (0.51)                            
sizeMedium                      -0.14        -0.27         -0.14                             
                                (0.47)       (0.44)        (0.47)                            
sizeSmall                        0.58         0.46          0.65                             
                                (0.45)       (0.42)        (0.45)                            
sizeMicro                       -0.69        -0.66         -0.60                             
                                (0.51)       (0.46)        (0.50)                            
subsectorHotelsRestBar          -1.78 *                    -1.71 *                           
                                (0.87)                     (0.87)                            
subsectorIndustry               -0.98                      -0.98                             
                                (0.71)                     (0.71)                            
subsectorServices_Hi           -16.93                     -17.06                             
                             (1290.84)                  (1289.47)                            
subsectorServices_Low           -0.76                      -0.75                             
                                (0.74)                     (0.74)                            
subsectorServices_Mid           -0.52                      -0.47                             
                                (0.79)                     (0.79)                            
subsectorTransport              -1.85                      -1.98                             
                                (1.10)                     (1.11)                            
subsectorWholesale               0.16                       0.05                             
                                (0.94)                     (0.94)                            
yearsquant(8,16]                -0.21        -0.06         -0.22                             
                                (0.56)       (0.54)        (0.56)                            
yearsquant(16,25]                0.68         0.79          0.70                             
                                (0.50)       (0.48)        (0.50)                            
yearsquant(25,34]               -0.45        -0.27         -0.37                             
                                (0.59)       (0.54)        (0.58)                            
yearsquant(34,43]                1.07 *       0.92          1.11 *                           
                                (0.52)       (0.48)        (0.52)                            
loghoms                         -0.06                                                        
                                (0.24)                                                       
logpop                           0.47         0.38                                           
                                (0.36)       (0.21)                                          
---------------------------------------------------------------------------------------------
AIC                            354.90       342.21        353.83      354.37       364.59    
BIC                            509.55       421.74        499.64      429.48       404.35    
Log Likelihood                -142.45      -153.10       -143.92     -160.18      -173.29    
Deviance                       284.90       306.21        287.83      320.37       346.59    
Num. obs.                      613          613           613         613          613       
=============================================================================================
*** p < 0.001, ** p < 0.01, * p < 0.05
```
...
Model 2: complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
  ...
  Resid. Df Resid. Dev Df Deviance  Pr(>Chi)    
1       612     439.55                          
2       578     284.90 34   154.64 < 2.2e-16 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
complied_bin ~ extortion_type + time + n_offenders + had_weapon +  
    with_violence + reported + rep_extortion_victim + bribe_victim +  
    size + subsector + yearsquant + loghoms + logpop + (1 | CVE_UNICA)
   Data: m1df

     AIC      BIC   logLik deviance df.resid 
   288.3    447.4   -108.2    216.3      577 

Scaled residuals: 
     Min       1Q   Median       3Q      Max 
-1.11935 -0.00201 -0.00032 -0.00002  1.76089 

Random effects:
 Groups    Name        Variance Std.Dev.
 CVE_UNICA (Intercept) 352      18.76   
Number of obs: 613, groups:  CVE_UNICA, 501

Fixed effects:
                              Estimate Std. Error z value Pr(>|z|)  
(Intercept)                  2.607e+00  1.106e+01   0.236   0.8137  
extortion_typeStreet         3.507e+00  9.377e+00   0.374   0.7084  
extortion_typePremises       1.297e+02  2.023e+07   0.000   1.0000  
extortion_typeCobro de piso  8.297e+00  2.221e+01   0.374   0.7087  
timeAfternoon               -3.019e+00  6.321e+00  -0.478   0.6329  
timeEvening                 -1.549e+00  5.367e+00  -0.289   0.7728  
timeNight                    6.472e+00  1.688e+01   0.384   0.7014  
timeDK/DA                   -1.642e+01  2.401e+01  -0.684   0.4940  
n_offenders2                 9.698e-01  5.193e+00   0.187   0.8519  
n_offenders3                -1.312e+00  1.252e+01  -0.105   0.9166  
n_offenders4+                7.108e+00  1.462e+01   0.486   0.6268  
n_offendersDK/DA            -4.615e+00  8.259e+00  -0.559   0.5763  
had_weaponYes                1.721e+01  1.160e+01   1.484   0.1379  
had_weaponDK/DA             -1.642e+00  6.192e+00  -0.265   0.7909  
with_violenceYes            -4.866e+00  1.418e+01  -0.343   0.7315  
with_violenceDK/DA           7.854e-01  1.418e+01   0.055   0.9558  
reportedYes                  9.152e-01  7.175e+00   0.128   0.8985  
rep_extortion_victim1        1.863e+00  1.232e+01   0.151   0.8798  
bribe_victim1               -3.258e+00  8.595e+00  -0.379   0.7047  
sizeMedium                  -4.632e+00  8.485e+00  -0.546   0.5851  
sizeSmall                   -1.327e-01  7.141e+00  -0.019   0.9852  
sizeMicro                   -1.335e+00  9.121e+00  -0.146   0.8836  
subsectorHotelsRestBar      -1.034e+01  1.691e+01  -0.612   0.5408  
subsectorIndustry           -1.024e+01  9.796e+00  -1.046   0.2957  
subsectorServices_Hi        -9.256e+02  1.464e+07   0.000   0.9999  
subsectorServices_Low       -8.358e+00  1.041e+01  -0.803   0.4221  
subsectorServices_Mid       -7.715e+00  1.176e+01  -0.656   0.5118  
subsectorTransport          -3.466e+01  1.577e+01  -2.198   0.0279 *
subsectorWholesale          -5.935e+00  1.398e+01  -0.424   0.6712  
yearsquant(8,16]            -4.372e+00  1.016e+01  -0.430   0.6669  
yearsquant(16,25]           -4.158e+00  8.082e+00  -0.514   0.6069  
yearsquant(25,34]           -7.623e+00  1.218e+01  -0.626   0.5315  
yearsquant(34,43]           -3.615e+00  9.168e+00  -0.394   0.6933  
loghoms                     -1.507e+00  4.880e+00  -0.309   0.7575  
logpop                       2.707e+00  7.085e+00   0.382   0.7024  
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
Generalized linear mixed model
 Family: binomial (logit)
Formula: complied_bin ~ extortion_type + time + n_offenders + had_weapon + with_violence + reported + rep_extortion_victim + bribe_victim + size + subsector + yearsquant + loghoms + logpop + (1 | CVE_UNICA)

  ICC (CVE_UNICA): 0.990742
```
...
Formula: complied_bin ~ extortion_type + time + n_offenders + had_weapon + with_violence + reported + rep_extortion_victim + bribe_victim + size + subsector + yearsquant + loghoms + logpop + (1 | CVE_UNICA)
      ...
      Within-group-variance:    3.290
     Between-group-variance:  352.046 (CVE_UNICA)
```
...
(Intercept)                          2.61  
                                   (11.06) 
extortion_typeStreet                 3.51  
                                    (9.38) 
extortion_typePremises             129.66  
                             (20234083.82) 
extortion_typeCobro de piso          8.30  
                                   (22.21) 
timeAfternoon                       -3.02  
                                    (6.32) 
timeEvening                         -1.55  
...
had_weaponYes                       17.21  
                                   (11.60) 
had_weaponDK/DA                     -1.64  
                                    (6.19) 
with_violenceYes                    -4.87  
                                   (14.18) 
with_violenceDK/DA                   0.79  
                                   (14.18) 
reportedYes                          0.92  
                                    (7.17) 
rep_extortion_victim1                1.86  
                                   (12.32) 
bribe_victim1                       -3.26  
                                    (8.59) 
sizeMedium                          -4.63  
...
sizeMicro                           -1.33  
                                    (9.12) 
subsectorHotelsRestBar             -10.34  
                                   (16.91) 
subsectorIndustry                  -10.24  
                                    (9.80) 
subsectorServices_Hi              -925.59  
                             (14644354.72) 
subsectorServices_Low               -8.36  
                                   (10.41) 
subsectorServices_Mid               -7.72  
                                   (11.76) 
subsectorTransport                 -34.66 *
                                   (15.77) 
subsectorWholesale                  -5.93  
                                   (13.98) 
yearsquant(8,16]                    -4.37  
                                   (10.16) 
yearsquant(16,25]                   -4.16  
                                    (8.08) 
yearsquant(25,34]                   -7.62  
                                   (12.18) 
yearsquant(34,43]                   -3.62  
                                    (9.17) 
loghoms                             -1.51  
                                    (4.88) 
logpop                               2.71  
...
AIC                                288.33  
BIC                                447.39  
Log Likelihood                    -108.17  
Num. obs.                          613     
Num. groups: CVE_UNICA             501     
Var: CVE_UNICA (Intercept)         352.05  
===========================================
*** p < 0.001, ** p < 0.01, * p < 0.05
```
...
n1_l2:     size + subsector + yearsquant + loghoms + logpop + (1 | CVE_UNICA)
           Df    AIC    BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)
n1_l2_null  2 223.08 231.92 -109.54   219.08                         
n1_l2      36 288.33 447.39 -108.17   216.33 2.7494     34          1
```
...
|n1_l2      | 36| 288.3302| 447.3913| -108.1651| 216.3302| 2.749406|     34|          1|
...
n1_l2_null  2 223.08 231.92 -109.54   219.08 220.4669      1     <2e-16
n1_l2      36 288.33 447.39 -108.17   216.33   2.7494     34          1
...
|n1_l2_null |  2| 223.0796| 231.9163| -109.5398| 219.0796| 220.466920|      1|          0|
|n1_l2      | 36| 288.3302| 447.3913| -108.1651| 216.3302|   2.749406|     34|          1|
...
```
  model              RMSE             NRMSE             CVRMSE
1    n1 0.255821662078108 0.999184006392061  0.154549739415429
2 n1_l2   0.0498895782366  1.00098298797464 0.0380175205439682
```
...
|model |RMSE              |NRMSE             |CVRMSE             |
|:-----|:-----------------|:-----------------|:------------------|
|n1    |0.255821662078108 |0.999184006392061 |0.154549739415429  |
|n1_l2 |0.0498895782366   |1.00098298797464  |0.0380175205439682 |
...
(Intercept)                     -2.58 **           2.61  
                                (0.88)           (11.06) 
extortion_typeStreet             1.11              3.51  
                                (0.61)            (9.38) 
extortion_typePremises          19.10            129.66  
                             (1738.19)     (20234083.82) 
extortion_typeCobro de piso      2.72 **           8.30  
                                (1.02)           (22.21) 
timeAfternoon                    0.11             -3.02  
                                (0.39)            (6.32) 
timeEvening                     -0.28             -1.55  
                                (0.51)            (5.37) 
timeNight                        1.90              6.47  
                                (1.08)           (16.88) 
timeDK/DA                        1.73            -16.42  
                                (1.49)           (24.01) 
n_offenders2                     1.09 **           0.97  
                                (0.38)            (5.19) 
n_offenders3                     0.92             -1.31  
                                (0.67)           (12.52) 
n_offenders4+                    2.90 ***          7.11  
                                (0.85)           (14.62) 
n_offendersDK/DA                 0.38             -4.62  
                                (0.78)            (8.26) 
had_weaponYes                    0.99             17.21  
                                (0.78)           (11.60) 
had_weaponDK/DA                 -0.02             -1.64  
                                (0.38)            (6.19) 
with_violenceYes                 0.40             -4.87  
                                (0.89)           (14.18) 
with_violenceDK/DA               0.73              0.79  
                                (0.66)           (14.18) 
reportedYes                      0.69              0.92  
                                (0.41)            (7.17) 
rep_extortion_victim1            0.89              1.86  
                                (0.57)           (12.32) 
bribe_victim1                   -0.01             -3.26  
                                (0.51)            (8.59) 
sizeMedium                      -0.14             -4.63  
                                (0.47)            (8.48) 
sizeSmall                        0.58             -0.13  
                                (0.45)            (7.14) 
sizeMicro                       -0.69             -1.33  
                                (0.51)            (9.12) 
subsectorHotelsRestBar          -1.78 *          -10.34  
                                (0.87)           (16.91) 
subsectorIndustry               -0.98            -10.24  
                                (0.71)            (9.80) 
subsectorServices_Hi           -16.93           -925.59  
                             (1290.84)     (14644354.72) 
subsectorServices_Low           -0.76             -8.36  
                                (0.74)           (10.41) 
subsectorServices_Mid           -0.52             -7.72  
                                (0.79)           (11.76) 
subsectorTransport              -1.85            -34.66 *
                                (1.10)           (15.77) 
subsectorWholesale               0.16             -5.93  
                                (0.94)           (13.98) 
yearsquant(8,16]                -0.21             -4.37  
                                (0.56)           (10.16) 
yearsquant(16,25]                0.68             -4.16  
                                (0.50)            (8.08) 
yearsquant(25,34]               -0.45             -7.62  
                                (0.59)           (12.18) 
yearsquant(34,43]                1.07 *           -3.62  
                                (0.52)            (9.17) 
loghoms                         -0.06             -1.51  
                                (0.24)            (4.88) 
logpop                           0.47              2.71  
...
n1:     size + subsector + yearsquant + loghoms + logpop
n1_l2: complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
n1_l2:     with_violence + reported + rep_extortion_victim + bribe_victim + 
n1_l2:     size + subsector + yearsquant + loghoms + logpop + (1 | CVE_UNICA)
      Df    AIC    BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)    
n1    35 354.90 509.55 -142.45   284.90                             
n1_l2 36 288.33 447.39 -108.17   216.33 68.575      1  < 2.2e-16 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
|      | Df|      AIC|      BIC|    logLik| deviance|    Chisq| Chi Df| Pr(>Chisq)|
|:-----|--:|--------:|--------:|---------:|--------:|--------:|------:|----------:|
|n1    | 35| 354.9047| 509.5475| -142.4524| 284.9047|       NA|     NA|         NA|
|n1_l2 | 36| 288.3302| 447.3913| -108.1651| 216.3302| 68.57454|      1|          0|
...
complied_bin ~ extortion_type + time + n_offenders + had_weapon +  
   ...
   Data: m1df
     ...
     AIC      BIC   logLik deviance df.resid 
   298.1    461.6   -112.0    224.1      576 

Scaled residuals: 
    Min      1Q  Median      3Q     Max 
-0.5873 -0.0012 -0.0001  0.0000  1.7026 

Random effects:
 Groups    Name        Variance Std.Dev.
 CVE_UNICA (Intercept) 337.594  18.374  
 CVE_ENT   (Intercept)   1.566   1.251  
Number of obs: 613, groups:  CVE_UNICA, 501; CVE_ENT, 32

Fixed effects:
                              Estimate Std. Error z value Pr(>|z|)
(Intercept)                 -9.790e-01  1.125e+01  -0.087    0.931
extortion_typeStreet        -7.165e+00  8.866e+00  -0.808    0.419
extortion_typePremises       2.047e+01  1.111e+02   0.184    0.854
extortion_typeCobro de piso -1.887e+01  1.733e+01  -1.089    0.276
timeAfternoon               -1.863e+00  5.967e+00  -0.312    0.755
timeEvening                 -1.571e+00  5.461e+00  -0.288    0.774
timeNight                    4.323e+00  2.198e+01   0.197    0.844
timeDK/DA                   -2.338e-01  2.377e+01  -0.010    0.992
n_offenders2                 3.519e+00  5.237e+00   0.672    0.502
n_offenders3                 4.198e+00  9.593e+00   0.438    0.662
n_offenders4+                1.882e+01  1.276e+01   1.475    0.140
n_offendersDK/DA            -3.578e+00  9.757e+00  -0.367    0.714
had_weaponYes                1.080e+01  1.091e+01   0.990    0.322
had_weaponDK/DA             -3.938e+00  6.269e+00  -0.628    0.530
with_violenceYes             5.191e+00  1.291e+01   0.402    0.688
with_violenceDK/DA           2.317e+00  1.211e+01   0.191    0.848
reportedYes                  3.704e+00  6.540e+00   0.566    0.571
rep_extortion_victim1        2.758e+00  1.136e+01   0.243    0.808
bribe_victim1                1.846e+00  8.561e+00   0.216    0.829
sizeMedium                   6.868e-01  8.085e+00   0.085    0.932
sizeSmall                    2.332e+00  6.888e+00   0.339    0.735
sizeMicro                   -7.620e-01  9.393e+00  -0.081    0.935
subsectorHotelsRestBar      -2.211e+01  1.517e+01  -1.458    0.145
subsectorIndustry           -1.425e+01  8.850e+00  -1.610    0.107
subsectorServices_Hi        -7.127e+02  1.464e+07   0.000    1.000
subsectorServices_Low       -1.400e+01  9.544e+00  -1.467    0.142
subsectorServices_Mid       -1.524e+01  1.079e+01  -1.412    0.158
subsectorTransport          -1.899e+01  1.470e+01  -1.292    0.196
subsectorWholesale          -1.241e+01  1.381e+01  -0.898    0.369
yearsquant(8,16]             1.715e+00  9.764e+00   0.176    0.861
yearsquant(16,25]            2.401e+00  9.132e+00   0.263    0.793
yearsquant(25,34]           -1.179e+01  1.055e+01  -1.118    0.263
yearsquant(34,43]            4.991e+00  9.484e+00   0.526    0.599
loghoms                     -1.174e+00  4.147e+00  -0.283    0.777
logpop                       2.205e+00  6.457e+00   0.342    0.733
```
...
Generalized linear mixed model
 Family: binomial (logit)
Formula: complied_bin ~ extortion_type + time + n_offenders + had_weapon + with_violence + reported + rep_extortion_victim + bribe_victim + size + subsector + yearsquant + loghoms + logpop + (1 | CVE_UNICA) + (1 | CVE_ENT)

      Within-group-variance:    3.290
     Between-group-variance:  337.594 (CVE_UNICA)
     Between-group-variance:    1.566 (CVE_ENT)
```
...
(Intercept)                         -0.98 
                                   (11.25)
extortion_typeStreet                -7.17 
                                    (8.87)
extortion_typePremises              20.47 
                                  (111.09)
extortion_typeCobro de piso        -18.87 
                                   (17.33)
timeAfternoon                       -1.86 
                                    (5.97)
timeEvening                         -1.57 
...
n_offenders4+                       18.82 
                                   (12.76)
n_offendersDK/DA                    -3.58 
                                    (9.76)
had_weaponYes                       10.80 
                                   (10.91)
had_weaponDK/DA                     -3.94 
                                    (6.27)
with_violenceYes                     5.19 
                                   (12.91)
with_violenceDK/DA                   2.32 
                                   (12.11)
reportedYes                          3.70 
                                    (6.54)
rep_extortion_victim1                2.76 
                                   (11.36)
bribe_victim1                        1.85 
                                    (8.56)
sizeMedium                           0.69 
...
sizeMicro                           -0.76 
                                    (9.39)
subsectorHotelsRestBar             -22.11 
                                   (15.17)
subsectorIndustry                  -14.25 
                                    (8.85)
subsectorServices_Hi              -712.69 
                             (14644354.72)
subsectorServices_Low              -14.00 
                                    (9.54)
subsectorServices_Mid              -15.24 
                                   (10.79)
subsectorTransport                 -18.99 
                                   (14.70)
subsectorWholesale                 -12.41 
                                   (13.81)
yearsquant(8,16]                     1.71 
                                    (9.76)
yearsquant(16,25]                    2.40 
                                    (9.13)
yearsquant(25,34]                  -11.79 
                                   (10.55)
yearsquant(34,43]                    4.99 
                                    (9.48)
loghoms                             -1.17 
                                    (4.15)
logpop                               2.20 
...
AIC                                298.07 
BIC                                461.55 
Log Likelihood                    -112.04 
Num. obs.                          613    
Num. groups: CVE_UNICA             501    
Num. groups: CVE_ENT                32    
Var: CVE_UNICA (Intercept)         337.59 
Var: CVE_ENT (Intercept)             1.57 
==========================================
*** p < 0.001, ** p < 0.01, * p < 0.05
```
...
```
Warning in checkConv(attr(opt, "derivs"), opt$par, ctrl = control
$checkConv, : Model failed to converge: degenerate Hessian with 9 negative
eigenvalues
```
...
|                     | Df|      AIC|        LRT|   Pr(Chi)|
|:--------------------|--:|--------:|----------:|---------:|
|<none>               | NA| 298.0735|         NA|        NA|
|extortion_type       |  3| 297.9465|   5.873019| 0.1179542|
|time                 |  4| 268.9383| -21.135237| 1.0000000|
|n_offenders          |  4| 283.5126|  -6.560930| 1.0000000|
|had_weapon           |  2| 302.0008|   7.927285| 0.0189938|
|with_violence        |  2| 264.1118| -29.961670| 1.0000000|
|reported             |  1| 274.4326| -21.640877| 1.0000000|
|rep_extortion_victim |  1| 299.2680|   3.194536| 0.0738848|
|bribe_victim         |  1| 351.4204|  55.346905| 0.0000000|
|size                 |  3| 308.0075|  15.933969| 0.0011699|
|subsector            |  7| 302.8516|  18.778126| 0.0089115|
|yearsquant           |  4| 303.4254|  13.351931| 0.0096783|
|loghoms              |  1| 298.0464|   1.972910| 0.1601393|
|logpop               |  1| 303.7646|   7.691059| 0.0055495|
...
|   2| -109.5398|  1| 220.4669203|  0.0000000|
|   3| -109.5398|  1|   0.0000005|  0.9994614|
|  37| -112.0368| 34|   4.9939023|  1.0000000|
...
n1_l3:     size + subsector + yearsquant + loghoms + logpop + (1 | CVE_UNICA) + 
n1_l3:     (1 | CVE_ENT)
           Df    AIC    BIC  logLik deviance Chisq Chi Df Pr(>Chisq)
n1_l3_null  3 225.08 238.33 -109.54   219.08                        
n1_l3      37 298.07 461.55 -112.04   224.07     0     34          1
```
...
|n1_l3      | 37| 298.0735| 461.5530| -112.0368| 224.0735|     0|     34|          1|
...
n1_l3:     (1 | CVE_ENT)
           Df    AIC    BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)    
n1_null     1 441.55 445.96 -219.77   439.55                             
n1_l3_null  3 225.08 238.33 -109.54   219.08 220.47      2     <2e-16 ***
n1_l3      37 298.07 461.55 -112.04   224.07   0.00     34          1    
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
|n1_l3      | 37| 298.0735| 461.5530| -112.0368| 224.0735|   0.0000|     34|          1|
...
1    n1  0.255821662078108 0.999184006392061  0.154549739415429
2 n1_l2    0.0498895782366  1.00098298797464 0.0380175205439682
3 n1_l3 0.0409908741968358  1.00267904600258 0.0409908741968358
```
...
|n1    |0.255821662078108  |0.999184006392061 |0.154549739415429  |
|n1_l2 |0.0498895782366    |1.00098298797464  |0.0380175205439682 |
|n1_l3 |0.0409908741968358 |1.00267904600258  |0.0409908741968358 |
...
(Intercept)                     -2.58 **          -0.98 
                                (0.88)           (11.25)
extortion_typeStreet             1.11             -7.17 
                                (0.61)            (8.87)
extortion_typePremises          19.10             20.47 
                             (1738.19)          (111.09)
extortion_typeCobro de piso      2.72 **         -18.87 
                                (1.02)           (17.33)
timeAfternoon                    0.11             -1.86 
                                (0.39)            (5.97)
timeEvening                     -0.28             -1.57 
                                (0.51)            (5.46)
timeNight                        1.90              4.32 
                                (1.08)           (21.98)
timeDK/DA                        1.73             -0.23 
                                (1.49)           (23.77)
n_offenders2                     1.09 **           3.52 
                                (0.38)            (5.24)
n_offenders3                     0.92              4.20 
                                (0.67)            (9.59)
n_offenders4+                    2.90 ***         18.82 
                                (0.85)           (12.76)
n_offendersDK/DA                 0.38             -3.58 
                                (0.78)            (9.76)
had_weaponYes                    0.99             10.80 
                                (0.78)           (10.91)
had_weaponDK/DA                 -0.02             -3.94 
                                (0.38)            (6.27)
with_violenceYes                 0.40              5.19 
                                (0.89)           (12.91)
with_violenceDK/DA               0.73              2.32 
                                (0.66)           (12.11)
reportedYes                      0.69              3.70 
                                (0.41)            (6.54)
rep_extortion_victim1            0.89              2.76 
                                (0.57)           (11.36)
bribe_victim1                   -0.01              1.85 
                                (0.51)            (8.56)
sizeMedium                      -0.14              0.69 
                                (0.47)            (8.09)
sizeSmall                        0.58              2.33 
                                (0.45)            (6.89)
sizeMicro                       -0.69             -0.76 
                                (0.51)            (9.39)
subsectorHotelsRestBar          -1.78 *          -22.11 
                                (0.87)           (15.17)
subsectorIndustry               -0.98            -14.25 
                                (0.71)            (8.85)
subsectorServices_Hi           -16.93           -712.69 
                             (1290.84)     (14644354.72)
subsectorServices_Low           -0.76            -14.00 
                                (0.74)            (9.54)
subsectorServices_Mid           -0.52            -15.24 
                                (0.79)           (10.79)
subsectorTransport              -1.85            -18.99 
                                (1.10)           (14.70)
subsectorWholesale               0.16            -12.41 
                                (0.94)           (13.81)
yearsquant(8,16]                -0.21              1.71 
                                (0.56)            (9.76)
yearsquant(16,25]                0.68              2.40 
                                (0.50)            (9.13)
yearsquant(25,34]               -0.45            -11.79 
                                (0.59)           (10.55)
yearsquant(34,43]                1.07 *            4.99 
                                (0.52)            (9.48)
loghoms                         -0.06             -1.17 
                                (0.24)            (4.15)
logpop                           0.47              2.20 
...
========================================================================
                             Model 1       Model 2         Model 3      
------------------------------------------------------------------------
(Intercept)                     -2.58 **           2.61           -0.98 
                                (0.88)           (11.06)         (11.25)
extortion_typeStreet             1.11              3.51           -7.17 
                                (0.61)            (9.38)          (8.87)
extortion_typePremises          19.10            129.66           20.47 
                             (1738.19)     (20234083.82)        (111.09)
extortion_typeCobro de piso      2.72 **           8.30          -18.87 
                                (1.02)           (22.21)         (17.33)
timeAfternoon                    0.11             -3.02           -1.86 
                                (0.39)            (6.32)          (5.97)
timeEvening                     -0.28             -1.55           -1.57 
                                (0.51)            (5.37)          (5.46)
timeNight                        1.90              6.47            4.32 
                                (1.08)           (16.88)         (21.98)
timeDK/DA                        1.73            -16.42           -0.23 
                                (1.49)           (24.01)         (23.77)
n_offenders2                     1.09 **           0.97            3.52 
                                (0.38)            (5.19)          (5.24)
n_offenders3                     0.92             -1.31            4.20 
                                (0.67)           (12.52)          (9.59)
n_offenders4+                    2.90 ***          7.11           18.82 
                                (0.85)           (14.62)         (12.76)
n_offendersDK/DA                 0.38             -4.62           -3.58 
                                (0.78)            (8.26)          (9.76)
had_weaponYes                    0.99             17.21           10.80 
                                (0.78)           (11.60)         (10.91)
had_weaponDK/DA                 -0.02             -1.64           -3.94 
                                (0.38)            (6.19)          (6.27)
with_violenceYes                 0.40             -4.87            5.19 
                                (0.89)           (14.18)         (12.91)
with_violenceDK/DA               0.73              0.79            2.32 
                                (0.66)           (14.18)         (12.11)
reportedYes                      0.69              0.92            3.70 
                                (0.41)            (7.17)          (6.54)
rep_extortion_victim1            0.89              1.86            2.76 
                                (0.57)           (12.32)         (11.36)
bribe_victim1                   -0.01             -3.26            1.85 
                                (0.51)            (8.59)          (8.56)
sizeMedium                      -0.14             -4.63            0.69 
                                (0.47)            (8.48)          (8.09)
sizeSmall                        0.58             -0.13            2.33 
                                (0.45)            (7.14)          (6.89)
sizeMicro                       -0.69             -1.33           -0.76 
                                (0.51)            (9.12)          (9.39)
subsectorHotelsRestBar          -1.78 *          -10.34          -22.11 
                                (0.87)           (16.91)         (15.17)
subsectorIndustry               -0.98            -10.24          -14.25 
                                (0.71)            (9.80)          (8.85)
subsectorServices_Hi           -16.93           -925.59         -712.69 
                             (1290.84)     (14644354.72)   (14644354.72)
subsectorServices_Low           -0.76             -8.36          -14.00 
                                (0.74)           (10.41)          (9.54)
subsectorServices_Mid           -0.52             -7.72          -15.24 
                                (0.79)           (11.76)         (10.79)
subsectorTransport              -1.85            -34.66 *        -18.99 
                                (1.10)           (15.77)         (14.70)
subsectorWholesale               0.16             -5.93          -12.41 
                                (0.94)           (13.98)         (13.81)
yearsquant(8,16]                -0.21             -4.37            1.71 
                                (0.56)           (10.16)          (9.76)
yearsquant(16,25]                0.68             -4.16            2.40 
                                (0.50)            (8.08)          (9.13)
yearsquant(25,34]               -0.45             -7.62          -11.79 
                                (0.59)           (12.18)         (10.55)
yearsquant(34,43]                1.07 *           -3.62            4.99 
                                (0.52)            (9.17)          (9.48)
loghoms                         -0.06             -1.51           -1.17 
                                (0.24)            (4.88)          (4.15)
logpop                           0.47              2.71            2.20 
                                (0.36)            (7.08)          (6.46)
------------------------------------------------------------------------
AIC                            354.90            288.33          298.07 
BIC                            509.55            447.39          461.55 
Log Likelihood                -142.45           -108.17         -112.04 
Deviance                       284.90                                   
Num. obs.                      613               613             613    
Num. groups: CVE_UNICA                           501             501    
Var: CVE_UNICA (Intercept)                       352.05          337.59 
Num. groups: CVE_ENT                                              32    
Var: CVE_ENT (Intercept)                                           1.57 
========================================================================
*** p < 0.001, ** p < 0.01, * p < 0.05
...
Model 2: complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
  ...
  #Df  LogLik Df  Chisq Pr(>Chisq)    
1  35 -142.45                         
2  37 -112.04  2 60.831  6.175e-14 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
n1_l3:     (1 | CVE_ENT)
      Df    AIC    BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)    
n1    35 354.90 509.55 -142.45   284.90                             
n1_l3 37 298.07 461.55 -112.04   224.07 60.831      2  6.175e-14 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
|:-----|--:|--------:|--------:|---------:|--------:|--------:|------:|----------:|
|n1    | 35| 354.9047| 509.5475| -142.4524| 284.9047|       NA|     NA|         NA|
|n1_l3 | 37| 298.0735| 461.5530| -112.0368| 224.0735| 60.83123|      2|          0|
...
Model 3: complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
  ...
  #Df  LogLik Df   Chisq Pr(>Chisq)    
1  35 -142.45                          
2  36 -108.17  1 68.5745  < 2.2e-16 ***
3  37 -112.04  1  7.7433   0.005391 ** 
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
|---:|---------:|--:|---------:|----------:|
|  35| -142.4524| NA|        NA|         NA|
|  36| -108.1651|  1| 68.574539|  0.0000000|
|  37| -112.0368|  1|  7.743308|  0.0053912|
...
n1_l3:     (1 | CVE_ENT)
      Df    AIC    BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)    
n1    35 354.90 509.55 -142.45   284.90                             
n1_l2 36 288.33 447.39 -108.17   216.33 68.575      1     <2e-16 ***
n1_l3 37 298.07 461.55 -112.04   224.07  0.000      1          1    
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
|n1    | 35| 354.9047| 509.5475| -142.4524| 284.9047|       NA|     NA|         NA|
|n1_l2 | 36| 288.3302| 447.3913| -108.1651| 216.3302| 68.57454|      1|          0|
|n1_l3 | 37| 298.0735| 461.5530| -112.0368| 224.0735|  0.00000|      1|          1|
...
n1_l3:     (1 | CVE_ENT)
      Df    AIC    BIC  logLik deviance Chisq Chi Df Pr(>Chisq)
n1_l2 36 288.33 447.39 -108.17   216.33                        
n1_l3 37 298.07 461.55 -112.04   224.07     0      1          1
```
...
|      | Df|      AIC|      BIC|    logLik| deviance| Chisq| Chi Df| Pr(>Chisq)|
|:-----|--:|--------:|--------:|---------:|--------:|-----:|------:|----------:|
|n1_l2 | 36| 288.3302| 447.3913| -108.1651| 216.3302|    NA|     NA|         NA|
|n1_l3 | 37| 298.0735| 461.5530| -112.0368| 224.0735|     0|      1|          1|
...
complied_bin ~ extortion_type + time + n_offenders + had_weapon +  
    with_violence + reported + rep_extortion_victim + bribe_victim +  
    size + subsector + yearsquant + (1 | CVE_UNICA) + (1 | CVE_ENT)
   Data: m1df

     AIC      BIC   logLik deviance df.resid 
   267.8    422.5    -98.9    197.8      578 

Scaled residuals: 
     Min       1Q   Median       3Q      Max 
-0.57379 -0.00021 -0.00001  0.00000  1.74278 

Random effects:
 Groups    Name        Variance Std.Dev.
 CVE_UNICA (Intercept) 897.510  29.958  
 CVE_ENT   (Intercept)   9.884   3.144  
Number of obs: 613, groups:  CVE_UNICA, 501; CVE_ENT, 32

Fixed effects:
                              Estimate Std. Error z value Pr(>|z|)
(Intercept)                 -8.448e+00  2.503e+01  -0.338    0.736
extortion_typeStreet         6.883e+00  1.449e+01   0.475    0.635
extortion_typePremises       2.380e+01  2.744e+02   0.087    0.931
extortion_typeCobro de piso  4.488e+00  2.674e+01   0.168    0.867
timeAfternoon                2.433e+00  1.032e+01   0.236    0.814
timeEvening                 -2.357e+00  1.004e+01  -0.235    0.814
timeNight                    9.488e+00  3.289e+01   0.288    0.773
timeDK/DA                    3.105e+00  3.515e+01   0.088    0.930
n_offenders2                 6.619e+00  9.901e+00   0.669    0.504
n_offenders3                 7.401e+00  1.571e+01   0.471    0.638
n_offenders4+                1.565e+01  2.180e+01   0.718    0.473
n_offendersDK/DA            -4.510e-01  1.071e+01  -0.042    0.966
had_weaponYes                1.005e+01  1.584e+01   0.634    0.526
had_weaponDK/DA             -4.934e+00  9.888e+00  -0.499    0.618
with_violenceYes            -2.997e+00  2.150e+01  -0.139    0.889
with_violenceDK/DA          -2.069e+00  2.294e+01  -0.090    0.928
reportedYes                  3.393e+00  1.112e+01   0.305    0.760
rep_extortion_victim1        2.370e+00  1.847e+01   0.128    0.898
bribe_victim1                3.901e+00  1.349e+01   0.289    0.772
sizeMedium                  -5.181e+00  1.359e+01  -0.381    0.703
sizeSmall                   -4.186e+00  1.205e+01  -0.347    0.728
sizeMicro                   -6.784e+00  1.602e+01  -0.424    0.672
subsectorHotelsRestBar      -1.856e+01  3.116e+01  -0.596    0.551
subsectorIndustry           -6.085e+00  1.997e+01  -0.305    0.761
subsectorServices_Hi        -1.857e+03  1.464e+07   0.000    1.000
subsectorServices_Low       -6.019e+00  2.080e+01  -0.289    0.772
subsectorServices_Mid       -5.381e+00  2.152e+01  -0.250    0.803
subsectorTransport          -2.484e+01  2.968e+01  -0.837    0.403
subsectorWholesale          -3.292e+00  2.530e+01  -0.130    0.896
yearsquant(8,16]            -4.085e+00  1.741e+01  -0.235    0.814
yearsquant(16,25]           -2.412e+00  1.381e+01  -0.175    0.861
yearsquant(25,34]           -6.401e+00  1.746e+01  -0.367    0.714
yearsquant(34,43]            1.588e+00  1.697e+01   0.094    0.925
```
...
Model 2: complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
  ...
  #Df   LogLik Df Chisq Pr(>Chisq)    
1  35  -98.917                        
2  37 -112.037  2 26.24  2.004e-06 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
| #Df|     LogLik| Df|    Chisq| Pr(>Chisq)|
|---:|----------:|--:|--------:|----------:|
|  35|  -98.91659| NA|       NA|         NA|
|  37| -112.03675|  2| 26.24032|      2e-06|
...
n1_l3_nostate:     size + subsector + yearsquant + (1 | CVE_UNICA) + (1 | CVE_ENT)
n1_l3: complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
n1_l3:     with_violence + reported + rep_extortion_victim + bribe_victim + 
n1_l3:     size + subsector + yearsquant + loghoms + logpop + (1 | CVE_UNICA) + 
n1_l3:     (1 | CVE_ENT)
              Df    AIC    BIC   logLik deviance Chisq Chi Df Pr(>Chisq)
n1_l3_nostate 35 267.83 422.48  -98.917   197.83                        
n1_l3         37 298.07 461.55 -112.037   224.07     0      2          1
```
...
|              | Df|      AIC|     BIC|     logLik| deviance| Chisq| Chi Df| Pr(>Chisq)|
|:-------------|--:|--------:|-------:|----------:|--------:|-----:|------:|----------:|
|n1_l3_nostate | 35| 267.8332| 422.476|  -98.91659| 197.8332|    NA|     NA|         NA|
|n1_l3         | 37| 298.0735| 461.553| -112.03675| 224.0735|     0|      2|          1|
...
| #Df|     LogLik| Df|    Chisq| Pr(>Chisq)|
|---:|----------:|--:|--------:|----------:|
|  19| -113.39749| NA|       NA|         NA|
|  35|  -98.91659| 16| 28.96179|   0.024195|
...
n1_l3_nostate:     size + subsector + yearsquant + (1 | CVE_UNICA) + (1 | CVE_ENT)
                    Df    AIC    BIC   logLik deviance  Chisq Chi Df
n1_l3_nostate_nobus 19 264.80 348.74 -113.397   226.79              
n1_l3_nostate       35 267.83 422.48  -98.917   197.83 28.962     16
                    Pr(>Chisq)  
n1_l3_nostate_nobus             
n1_l3_nostate           0.0242 *
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
|                    | Df|      AIC|      BIC|     logLik| deviance|    Chisq| Chi Df| Pr(>Chisq)|
|:-------------------|--:|--------:|--------:|----------:|--------:|--------:|------:|----------:|
|n1_l3_nostate_nobus | 19| 264.7950| 348.7439| -113.39749| 226.7950|       NA|     NA|         NA|
|n1_l3_nostate       | 35| 267.8332| 422.4760|  -98.91659| 197.8332| 28.96179|     16|   0.024195|
...
1  19 -113.397                         
2  35  -98.917 16 28.962     0.0242 *  
3  37 -112.037  2 26.240  2.004e-06 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
|  19| -113.39749| NA|       NA|         NA|
|  35|  -98.91659| 16| 28.96179|   0.024195|
|  37| -112.03675|  2| 26.24032|   0.000002|
...
n1_l3_nostate_nobus 19 264.80 348.74 -113.397   226.79              
n1_l3_nostate       35 267.83 422.48  -98.917   197.83 28.962     16
n1_l3               37 298.07 461.55 -112.037   224.07  0.000      2
                    Pr(>Chisq)  
n1_l3_nostate_nobus             
n1_l3_nostate           0.0242 *
n1_l3                   1.0000  
...
|n1_l3_nostate_nobus | 19| 264.7950| 348.7439| -113.39749| 226.7950|       NA|     NA|         NA|
|n1_l3_nostate       | 35| 267.8332| 422.4760|  -98.91659| 197.8332| 28.96179|     16|   0.024195|
|n1_l3               | 37| 298.0735| 461.5530| -112.03675| 224.0735|  0.00000|      2|   1.000000|
...
Model 4: complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
  ...
  #Df   LogLik Df   Chisq Pr(>Chisq)    
1   3 -109.540                          
2  19 -113.397 16  7.7154     0.9569    
3  35  -98.917 16 28.9618     0.0242 *  
4  37 -112.037  2 26.2403  2.004e-06 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
| #Df|     LogLik| Df|    Chisq| Pr(>Chisq)|
|---:|----------:|--:|--------:|----------:|
|   3| -109.53980| NA|       NA|         NA|
|  19| -113.39749| 16|  7.71537|  0.9568916|
|  35|  -98.91659| 16| 28.96179|  0.0241950|
|  37| -112.03675|  2| 26.24032|  0.0000020|
...
n1_l3:     (1 | CVE_ENT)
                    Df    AIC    BIC   logLik deviance  Chisq Chi Df
n1_l3_null           3 225.08 238.33 -109.540   219.08              
n1_l3_nostate_nobus 19 264.80 348.74 -113.397   226.79  0.000     16
n1_l3_nostate       35 267.83 422.48  -98.917   197.83 28.962     16
n1_l3               37 298.07 461.55 -112.037   224.07  0.000      2
                    Pr(>Chisq)  
n1_l3_null                      
n1_l3_nostate_nobus     1.0000  
n1_l3_nostate           0.0242 *
n1_l3                   1.0000  
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
|                    | Df|      AIC|      BIC|     logLik| deviance|    Chisq| Chi Df| Pr(>Chisq)|
|:-------------------|--:|--------:|--------:|----------:|--------:|--------:|------:|----------:|
|n1_l3_null          |  3| 225.0796| 238.3347| -109.53980| 219.0796|       NA|     NA|         NA|
|n1_l3_nostate_nobus | 19| 264.7950| 348.7439| -113.39749| 226.7950|  0.00000|     16|   1.000000|
|n1_l3_nostate       | 35| 267.8332| 422.4760|  -98.91659| 197.8332| 28.96179|     16|   0.024195|
|n1_l3               | 37| 298.0735| 461.5530| -112.03675| 224.0735|  0.00000|      2|   1.000000|
...
Model 4: complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
  ...
  #Df   LogLik Df  Chisq Pr(>Chisq)    
1  11 -112.287                         
2  19 -113.397  8  2.221     0.9735    
3  35  -98.917 16 28.962     0.0242 *  
4  37 -112.037  2 26.240  2.004e-06 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
| #Df|     LogLik| Df|     Chisq| Pr(>Chisq)|
|---:|----------:|--:|---------:|----------:|
|  11| -112.28697| NA|        NA|         NA|
|  19| -113.39749|  8|  2.221026|  0.9734748|
|  35|  -98.91659| 16| 28.961789|  0.0241950|
|  37| -112.03675|  2| 26.240321|  0.0000020|
...
n1_l3:     (1 | CVE_ENT)
                      Df    AIC    BIC   logLik deviance  Chisq Chi Df
n1_l3_no_viol_off_wea 11 246.57 295.18 -112.287   224.57              
n1_l3_nostate_nobus   19 264.80 348.74 -113.397   226.79  0.000      8
n1_l3_nostate         35 267.83 422.48  -98.917   197.83 28.962     16
n1_l3                 37 298.07 461.55 -112.037   224.07  0.000      2
                      Pr(>Chisq)  
n1_l3_no_viol_off_wea             
...
|                      | Df|      AIC|      BIC|     logLik| deviance|    Chisq| Chi Df| Pr(>Chisq)|
|:---------------------|--:|--------:|--------:|----------:|--------:|--------:|------:|----------:|
|n1_l3_no_viol_off_wea | 11| 246.5739| 295.1760| -112.28697| 224.5739|       NA|     NA|         NA|
|n1_l3_nostate_nobus   | 19| 264.7950| 348.7439| -113.39749| 226.7950|  0.00000|      8|   1.000000|
|n1_l3_nostate         | 35| 267.8332| 422.4760|  -98.91659| 197.8332| 28.96179|     16|   0.024195|
|n1_l3                 | 37| 298.0735| 461.5530| -112.03675| 224.0735|  0.00000|      2|   1.000000|
...
Model 5: complied_bin ~ extortion_type + time + n_offenders + had_weapon + 
  ...
  #Df   LogLik Df   Chisq Pr(>Chisq)    
1   3 -109.540                          
2  11 -112.287  8  5.4943     0.7037    
3  19 -113.397  8  2.2210     0.9735    
4  35  -98.917 16 28.9618     0.0242 *  
5  37 -112.037  2 26.2403  2.004e-06 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
| #Df|     LogLik|  Df|      Chisq| Pr(>Chisq)|
|---:|----------:|---:|----------:|----------:|
|  37| -112.03675|  NA|         NA|         NA|
|  11| -112.28697| -26|  0.5004421|  1.0000000|
|  19| -113.39749|   8|  2.2210262|  0.9734748|
|  35|  -98.91659|  16| 28.9617892|  0.0241950|
|  37| -112.03675|   2| 26.2403210|  0.0000020|
...
n1_l3:     (1 | CVE_ENT)
                      Df    AIC    BIC   logLik deviance  Chisq Chi Df
n1_l3_null             3 225.08 238.33 -109.540   219.08              
n1_l3_no_viol_off_wea 11 246.57 295.18 -112.287   224.57  0.000      8
n1_l3_nostate_nobus   19 264.80 348.74 -113.397   226.79  0.000      8
n1_l3_nostate         35 267.83 422.48  -98.917   197.83 28.962     16
n1_l3                 37 298.07 461.55 -112.037   224.07  0.000      2
                      Pr(>Chisq)  
n1_l3_null                        
n1_l3_no_viol_off_wea     1.0000  
n1_l3_nostate_nobus       1.0000  
n1_l3_nostate             0.0242 *
n1_l3                     1.0000  
---
...
|:---------------------|--:|--------:|--------:|----------:|--------:|--------:|------:|----------:|
|n1_l3_null            |  3| 225.0796| 238.3347| -109.53980| 219.0796|       NA|     NA|         NA|
|n1_l3_no_viol_off_wea | 11| 246.5739| 295.1760| -112.28697| 224.5739|  0.00000|      8|   1.000000|
|n1_l3_nostate_nobus   | 19| 264.7950| 348.7439| -113.39749| 226.7950|  0.00000|      8|   1.000000|
|n1_l3_nostate         | 35| 267.8332| 422.4760|  -98.91659| 197.8332| 28.96179|     16|   0.024195|
|n1_l3                 | 37| 298.0735| 461.5530| -112.03675| 224.0735|  0.00000|      2|   1.000000|
...
=======================================================================================================
                             Model 1        Model 2        Model 3         Model 4          Model 5    
-------------------------------------------------------------------------------------------------------
(Intercept)                         -0.98          -8.45         -10.57          -18.19 **   -12.03 ***
                                   (11.25)        (25.03)         (7.54)          (5.89)      (1.04)   
extortion_typeStreet                -7.17           6.88          -2.38            3.52                
                                    (8.87)        (14.49)        (12.50)          (7.05)               
extortion_typePremises              20.47          23.80         468.83           66.07                
                                  (111.09)       (274.42)  (20234083.82)   (20234083.82)               
extortion_typeCobro de piso        -18.87           4.49         -23.90           27.06 *              
                                   (17.33)        (26.74)        (22.21)         (13.70)               
timeAfternoon                       -1.86           2.43         -10.32            7.10                
                                    (5.97)        (10.32)         (8.29)          (6.56)               
timeEvening                         -1.57          -2.36          -0.52            6.38                
                                    (5.46)        (10.04)         (7.21)          (5.70)               
timeNight                            4.32           9.49         -16.47          -13.03                
                                   (21.98)        (32.89)        (22.45)         (17.20)               
timeDK/DA                           -0.23           3.10         -77.02 *         31.12                
                                   (23.77)        (35.15)        (32.08)         (17.42)               
n_offenders2                         3.52           6.62           1.56                                
                                    (5.24)         (9.90)         (6.96)                               
n_offenders3                         4.20           7.40           1.15                                
                                    (9.59)        (15.71)        (15.25)                               
n_offenders4+                       18.82          15.65           8.34                                
                                   (12.76)        (21.80)        (14.43)                               
n_offendersDK/DA                    -3.58          -0.45          -7.23                                
                                    (9.76)        (10.71)        (12.62)                               
had_weaponYes                       10.80          10.05          17.37                                
                                   (10.91)        (15.84)        (13.53)                               
had_weaponDK/DA                     -3.94          -4.93          -1.17                                
                                    (6.27)         (9.89)         (8.30)                               
with_violenceYes                     5.19          -3.00          -4.20                                
                                   (12.91)        (21.50)        (16.13)                               
with_violenceDK/DA                   2.32          -2.07          -1.15                                
                                   (12.11)        (22.94)        (16.37)                               
reportedYes                          3.70           3.39          -4.44           -0.54                
                                    (6.54)        (11.12)         (9.48)          (7.09)               
rep_extortion_victim1                2.76           2.37                                               
                                   (11.36)        (18.47)                                              
bribe_victim1                        1.85           3.90                                               
                                    (8.56)        (13.49)                                              
sizeMedium                           0.69          -5.18                                               
                                    (8.09)        (13.59)                                              
sizeSmall                            2.33          -4.19                                               
                                    (6.89)        (12.05)                                              
sizeMicro                           -0.76          -6.78                                               
                                    (9.39)        (16.02)                                              
subsectorHotelsRestBar             -22.11         -18.56                                               
                                   (15.17)        (31.16)                                              
subsectorIndustry                  -14.25          -6.08                                               
                                    (8.85)        (19.97)                                              
subsectorServices_Hi              -712.69       -1856.89                                               
                             (14644354.72)  (14644354.72)                                              
subsectorServices_Low              -14.00          -6.02                                               
                                    (9.54)        (20.80)                                              
subsectorServices_Mid              -15.24          -5.38                                               
                                   (10.79)        (21.52)                                              
subsectorTransport                 -18.99         -24.84                                               
                                   (14.70)        (29.68)                                              
subsectorWholesale                 -12.41          -3.29                                               
                                   (13.81)        (25.30)                                              
yearsquant(8,16]                     1.71          -4.08                                               
                                    (9.76)        (17.41)                                              
yearsquant(16,25]                    2.40          -2.41                                               
                                    (9.13)        (13.81)                                              
yearsquant(25,34]                  -11.79          -6.40                                               
                                   (10.55)        (17.46)                                              
yearsquant(34,43]                    4.99           1.59                                               
                                    (9.48)        (16.97)                                              
loghoms                             -1.17                                                              
                                    (4.15)                                                             
logpop                               2.20                                                              
                                    (6.46)                                                             
-------------------------------------------------------------------------------------------------------
AIC                                298.07         267.83         264.79          246.57      225.08    
BIC                                461.55         422.48         348.74          295.18      238.33    
Log Likelihood                    -112.04         -98.92        -113.40         -112.29     -109.54    
Num. obs.                          613            613            613             613         613       
Num. groups: CVE_UNICA             501            501            501             501         501       
Num. groups: CVE_ENT                32             32             32              32          32       
Var: CVE_UNICA (Intercept)         337.59         897.51         779.61          505.49     1485.72    
Var: CVE_ENT (Intercept)             1.57           9.88           0.00            0.72        0.00    
=======================================================================================================
*** p < 0.001, ** p < 0.01, * p < 0.05
```
...
```
[1] "the script took 2394.1 minutes to run."
```

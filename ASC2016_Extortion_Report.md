...
```
Working directory is /nfs/rcs/home2/uctz/uctzpre/projects/ENVE_ASC2016
```
...
data:  get(paste("t", i, sep = ""))
X-squared = 58.364, df = NA, p-value = 0.5284
...
1       634     461.19                                      
2       582     265.56 52   195.63 < 0.00000000000000022 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
| Resid. Df| Resid. Dev| Df| Deviance| Pr(>Chi)|
|---------:|----------:|--:|--------:|--------:|
|       634|   461.1913| NA|       NA|       NA|
|       582|   265.5579| 52| 195.6334|        0|
...
Model 2: complied_bin ~ extortion_type + request + month + time + n_offenders + 
  ...
  #Df  LogLik Df  Chisq       Pr(>Chisq)    
1  53 -132.78                               
2  54 -108.35  1 48.866 0.00000000000274 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
Formula: complied_bin ~ (1 | CVE_UNICA) + (1 | CVE_ENT)
      ...
      Within-group-variance:    3.290
     Between-group-variance: 1515.738 (CVE_UNICA)
...
Model 2: complied_bin ~ extortion_type + request + month + time + n_offenders + 
  ...
  #Df  LogLik Df  Chisq     Pr(>Chisq)    
1  53 -132.78                             
2  55 -112.10  2 41.355 0.000000001047 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
Model 3: complied_bin ~ extortion_type + request + month + time + n_offenders + 
  ...
  #Df  LogLik Df   Chisq       Pr(>Chisq)    
1  53 -132.78                                
2  54 -108.35  1 48.8662 0.00000000000274 ***
3  55 -112.10  1  7.5108         0.006133 ** 
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
|---:|---------:|--:|---------:|----------:|
|  53| -132.7790| NA|        NA|         NA|
|  54| -108.3458|  1| 48.866234|  0.0000000|
|  55| -112.1012|  1|  7.510756|  0.0061332|

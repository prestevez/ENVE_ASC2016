...
While this is a first approach, we will try some models to see how they behave.
...
For each GLMM get the number of observations per group, min, max and avg.

First we start with the most restricted not excluding weapons, violence or offender variables.



 LATER: the least missing excluding "with violence" and "offender" and "weapons" variables.



## Multilevel

Don't forget to implement some good plotting experiments regarding multilevel models

...
enve_test$id <- as.integer(as.character(enve_all$CVE_UNICA))
...
levels(enve_test$hotrestbar)[-hotindx] <- "No"
levels(enve_test$hotrestbar)[hotindx] <- "Yes"
enve_test$hotrestbar <- relevel(enve_test$hotrestbar, ref="No")
...
# Selecting only those relevant for extortion
